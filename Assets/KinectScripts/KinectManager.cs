...
public class KinectManager : MonoBehaviour
{
	...
	public Text calibrationRecText=null;
...
//				break;
	...
	void Awake() 
	{
		...
		catch (Exception ex) 
		{
			...
			calibrationRecText.text="ex.Message";
		}
...
//	        UserLost = new KinectWrapper.UserDelegate(OnUserLost);
			...
			calibrationRecText.text="WAITING FOR USERS";
		...
		catch(DllNotFoundException ex)
		{
			...
			*/
			calibrationRecText.text="Please check the OpenNI and NITE installations.";
		}
		catch (Exception ex) 
		{
			Debug.LogError(ex.ToString());
...
//	}
    ...
    void OnCalibrationStarted(uint UserId)
    {
		...
		/*if(CalibrationText != null)
		{
			CalibrationText.GetComponent<GUIText>().text = "CALIBRATING...PLEASE HOLD STILL";
		}*/
		calibrationRecText.text="CALIBRATING...PLEASE HOLD STILL";
